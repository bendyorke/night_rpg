defmodule NightRPGWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule NightRPG.MyChannel do
        use NightRPGWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :night_rpg,
                        pubsub_server: NightRPG.PubSub
end
